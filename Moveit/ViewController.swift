...
//        img2.clipsToBounds = true
       ...
       // self.edgesForExtendedLayout = UIRectEdge.None;
        ...
        { print("User logged in")
            ...
            if(UserDefaults.standard.bool(forKey: "FirstTimeLoginA123456789012345678901234567891234567890"))
           ...
           //         })
                ...
                UserDefaults.standard.set(true, forKey: "FirstTimeLoginA123456789012345678901234567891234567890");
                UserDefaults.standard.synchronize();
                print(UserDefaults.standard.bool(forKey: "FirstTimeLoginA123456789012345678901234567891234567890"));
            }
        }
    }
