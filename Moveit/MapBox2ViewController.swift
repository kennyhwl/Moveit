//
//  MapBox2ViewController.swift
//  
//
//  Created by Kenny Ho on 25/1/17.
//
//
...
class MapBox2ViewController: UIViewController, MGLMapViewDelegate {
    ...
    func mapView(_ mapView: MGLMapView, imageFor annotation: MGLAnnotation) -> MGLAnnotationImage? {
        ...
        if annotationImage == nil {
            ...
            var image = UIImage(named: "pisavector.png")!
